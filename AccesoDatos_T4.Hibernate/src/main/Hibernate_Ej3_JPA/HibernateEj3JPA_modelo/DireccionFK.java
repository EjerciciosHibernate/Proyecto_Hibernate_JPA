...
@Entity
@Table(name = "DireccionFK",uniqueConstraints=@UniqueConstraint(columnNames={"direccion_id"}))
public class DireccionFK {
	...
	public DireccionFK(String calle, int numero, String poblacion, String provincia) {
		super();
		this.calle = calle;
		this.numero = numero;
